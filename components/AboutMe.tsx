    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative group w-full max-w-[400px] h-[400px] md:h-[600px] mx-auto">
            <div className="absolute -top-3 -left-3 md:-top-4 md:-left-4 w-[calc(100%+1.5rem)] md:w-[calc(100%+2rem)] h-[calc(100%+1.5rem)] md:h-[calc(100%+2rem)] border-2 border-primary rounded-lg transition-all duration-300 group-hover:-top-4 group-hover:-left-4 md:group-hover:-top-6 md:group-hover:-left-6"></div>
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-300 mb-8 leading-relaxed">
              ...
              knowledge across different programming languages and
              architectures.
            </p>
